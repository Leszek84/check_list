# Cloud Task Manager (2026) by Leszek Kłapkowski 25483
...
* [x] **Artefakt 7:** Bezpieczne zarządzanie sekretami – integracja z Azure Key Vault, eliminacja sekretów z kodu źródłowego, wykorzystanie Managed Identity oraz potwierdzenie 
działania aplikacji po zmianach.
- [x] *Artefakt 8:* Testy jednostkowe, automatyzacja CI/CD (GitHub Actions) oraz wdrożenie metody DELETE na Azure.
