...
* [x] **Artefakt 7:** Bezpieczne zarządzanie sekretami – integracja z Azure Key Vault, eliminacja sekretów z kodu źródłowego, wykorzystanie Managed Identity oraz potwierdzenie działania aplikacji po zmianach.
